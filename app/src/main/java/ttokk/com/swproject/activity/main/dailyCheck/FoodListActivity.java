...
import ttokk.com.swproject.adapter.FoodAdapter;
import ttokk.com.swproject.model.sqliteDB.Food;
...
public class FoodListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // db 연결
        helper = new FoodSQLiteHelper(FoodListActivity.this, dbName, null, 3);
        ...
        do {
            ...
            int food_kcal = c.getInt(c.getColumnIndex("food_kcal"));
