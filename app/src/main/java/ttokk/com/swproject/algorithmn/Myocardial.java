...
public class Myocardial{
	...
	public Myocardial(int age, double creatinine, int is_hypertension, int is_diabetes, int leukocyte, int smoking, int total_colesterol, int HDL, int LDL, int HbA, double SBP, double DBP, int is_atrialFibrillation){
		this.age = age;
	...
	public double[] cal_myocardial() {
		...
		if (score < 100){ in_5 += 0.00; in_3 += 0.00; }
		else if (score >= 100 && score < 120){ in_5 += 0.01; in_3 += 0.00; }
		else if (score >= 120 && score < 122){ in_5 += 0.02; in_3 += 0.00; }
		else if (score >= 122 && score < 130){ in_5 += 0.02; in_3 += 0.01; }
		else if (score >= 130 && score < 141){ in_5 += 0.03; in_3 += 0.01; }
		else if (score >= 141 && score < 144){ in_5 += 0.03; in_3 += 0.02; }
		else if (score >= 144 && score < 152){ in_5 += 0.05; in_3 += 0.02; }
		else if (score >= 152 && score < 162){ in_5 += 0.05; in_3 += 0.03; }
		else if (score >= 162 && score < 165){ in_5 += 0.10; in_3 += 0.03; }
		else if (score >= 165 && score < 182){ in_5 += 0.10; in_3 += 0.05; }
		else if (score >= 182 && score < 184){ in_5 += 0.20; in_3 += 0.05; }
		else if (score >= 184 && score < 203){ in_5 += 0.20; in_3 += 0.10; }
		else if (score >= 203 && score < 204){ in_5 += 0.40; in_3 += 0.10; }
		else if (score >= 204 && score < 211){ in_5 += 0.40; in_3 += 0.20; }
		else if (score >= 211){ in_5 += 0.50; in_3 += 0.20; }

		double[]result = {in_3, in_5};
		return result;
