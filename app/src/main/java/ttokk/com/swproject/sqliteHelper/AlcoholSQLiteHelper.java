...
public class AlcoholSQLiteHelper extends SQLiteOpenHelper {

    public AlcoholSQLiteHelper(Context context, String name,
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sql = "create table if not exists alcoholTBL" +
                "(nmb integer primary key autoincrement, " +
                "alcohol_data integer, " +
                "date text);";
        db.execSQL(sql);
        Log.i("생성", "생성");
    }
