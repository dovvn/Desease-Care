...
public class WaterSQLiteHelper extends SQLiteOpenHelper {

    public WaterSQLiteHelper(Context context, String name,
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sql = "create table if not exists waterTBL" +
