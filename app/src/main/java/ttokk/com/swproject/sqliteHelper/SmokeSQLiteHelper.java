...
public class SmokeSQLiteHelper extends SQLiteOpenHelper {

    public SmokeSQLiteHelper(Context context, String name,
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sql = "create table if not exists smokeTBL" +
